...
class App2Vec:
	...
	# half ignore mode processing..
	def ignore_all_get_app(self,each_app_seq):
		app_seq_list = each_app_seq.split()
		result = []
...
if __name__ == "__main__":
	app2vec = App2Vec()
	app2vec.csv2training_data(raw_file_path = '/Users/apple/Documents/paper/userIntentDataset-master/resources/R1.csv')
